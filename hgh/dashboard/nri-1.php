						...
						<div class="card-body">
							<div class="table-responsive">
								<table id="example" class="display table dataTable table-striped table-bordered">
									...
									<?php 
									    if(!empty($nris) && is_array($nris) &&count($nris)>0){
									        foreach($nris as $nri)
									        {
								    ?>
									<tbody>
										<tr>
											...
											<td><?= $nri['email']; ?></td>
											<td><?= $nri['address']; ?></td>
											<td><a href="<?= 'default_view.php?type=nri&id='.$nri['id'] ?>"><span class="badge outline-badge-primary">View</span></a></td>
										</tr>
									</tbody>
    									<?php
    									        }
