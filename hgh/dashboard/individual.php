<?php
  ...
  $indvs = $db->getRows('investor_req_tbl',['where'=>"type='individual'"]);
?>
<!DOCTYPE html>
<html lang="en">
<!-- START: Head-->
    ...
    <body id="main-container" class="default">
    				...
    				<div class="col-12  align-self-center">
    					<div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
    						<div class="w-sm-100 mr-auto">
    							<h4 class="mb-0">Investor</h4></div>
    						<ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
    							<li class="breadcrumb-item">Home</li>
    							<li class="breadcrumb-item active"><a href="#">Investor</a></li>
    						</ol>
    					</div>
    				</div>
    			</div>
    				...
    				<div class="col-12 mt-3">
    					<div class="card">
    						<div class="card-header  justify-content-between align-items-center">
    							<h4 class="card-title">Data Table</h4> </div>
    						<div class="card-body">
    							<div class="table-responsive">
    								<table id="example" class="display table dataTable table-striped table-bordered">
    									...
    									<?php 
    									    if(!empty($indvs) && is_array($indvs) &&count($indvs)>0){
    									        foreach($indvs as $indv)
    									        {
									    ?>
    									<tbody>
    										<tr>
    											...
    											<td><?= $indv['mobile']; ?></td>
    											<td><?= $indv['email']; ?></td>
    											<td><?= $indv['property_type']; ?></td>
    											<td><?= $indv['location_pref']; ?></td>
    											<td><?= $indv['budget_type']; ?></td>
    											<td><?= $indv['land_mark']; ?></td>
    											<td><a href="view.html<?= '?type='.$indv['type'].'&id='.$indv['id']; ?>"><span class="badge outline-badge-primary">View</span></a></td>
    										</tr>
    									</tbody>
    									<?php
    									        }
    	...
    	<!-- END: Content-->
    	<!-- START: Footer-->
    	<footer class="site-footer"> 2020 &copy; Hyderabad Group Housing </footer>
    	<!-- END: Footer-->
    	<!-- START: Back to top-->
