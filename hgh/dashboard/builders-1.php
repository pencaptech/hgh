<?php
  ...
  $builders = $db->getRows('builder_tbl',[]);
?>
<!DOCTYPE html>
<html lang="en">
<!-- START: Head-->
						...
						<div class="card-body">
							<div class="table-responsive">
								<table id="example" class="display table dataTable table-striped table-bordered">
									...
									<?php 
									    if(!empty($builders) && is_array($builders) &&count($builders)>0){
									...
									<tbody>
										<tr>
											...
											<td><a href="<?= 'default_view.php?type=builder&id='.$builder['id'] ?>"><span class="badge outline-badge-primary">View</span></a></td>
										</tr>
									</tbody>
    									<?php
    									        }
