...
<head>
    ...
    <body id="main-container" class="default">
                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Builders</h4></div>
                                    ...
                                    <div class="row">                                           
                                        <div class="col-12">
                                            <form>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="btn btn-primary">Save</button>   <button type="submit" class="btn btn-outline-warning">Cancel</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <!-- START: Footer-->
        <footer class="site-footer" style="margin-top: 135px;">
