<?php
  ...
  $invests = $db->getRows('investor_tbl',[]);
?>
<!DOCTYPE html>
<html lang="en">
<!-- START: Head-->
...
<head>
	<meta charset="UTF-8">
	<title>:: Hyderabad Group Housing | NRI's ::</title>
				...
				<div class="col-12  align-self-center">
					<div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
						<div class="w-sm-100 mr-auto">
							<h4 class="mb-0">NRI's</h4></div>
						<ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
							<li class="breadcrumb-item">Home</li>
							<li class="breadcrumb-item active"><a href="#">NRI's</a></li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="card-body">
							<div class="table-responsive">
								<table id="example" class="display table dataTable table-striped table-bordered">
									...
									<?php 
									    if(!empty($invests) && is_array($invests) &&count($invests)>0){
									...
									<tbody>
										<tr>
											...
											<td><a href="<?= 'default_view.php?type=investment&id='.$invest['id'] ?>"><span class="badge outline-badge-primary">View</span></a></td>
										</tr>
									</tbody>
    									<?php
    									        }
